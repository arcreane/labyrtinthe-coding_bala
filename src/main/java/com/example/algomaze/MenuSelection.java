...
public class MenuSelection {
    ...
    public static int MenuData() {
        ...
        System.out.println("--------------------");
        System.out.println("1 - Easy mode maze ♥");
        System.out.println("2 - Medium mode maze ★");
        System.out.println("3 - Hard mode maze ☠");
        System.out.println("4 - Animated solved maze");
...
// menu to add while we display our labyrinth
    public static void menuFinish() throws IOException {
        ...
        System.out.println("---------------------");
        System.out.println("1 - Quit (RAGE QUIT)");
...
//    public static void time() throws IOException { //time to solve the maze
//        Scanner sc = new Scanner(System.in);
//        int timeline = 0;
//        long start = System.currentTimeMillis(); //start time
//        System.out.println("1 for leave");
//        while (true) {
//            try {
